...
static void loan()
{
	if (tree.findBook(currentISBN).b.onLoan == false)
	{
		...
		if (response == 0)
		{
			...
			System.out.println(tree.findBook(currentISBN).b.title + " succesfully loaned!");
			state = 0;
			switches();
		}
	}
	else if (tree.findBook(currentISBN).b.onLoan == true)
	{
		...
		{
			tree.loanBook(currentISBN);
			System.out.println(tree.findBook(currentISBN).b.title + " succesfully returned!");
			state = 0;
			switches();
		}		
	}
